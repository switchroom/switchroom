...
/** Result of `ensureKey`. `created` is false when a caller-side check
 * short-circuited (never returned by this module today — reserved), true
 * when a fresh key was generated by LiteLLM. */
