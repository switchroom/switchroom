---
name: switchroom-telegram-guide
description: Explains the switchroom-telegram plugin's features — 10 MCP tools (reply, stream_reply, react, edit, delete, forward, pin, typing, download, history), emoji status reactions, SQLite history, formatting, access control. Use when discussing Telegram integration, message handling, or formatting issues.
user-invocable: false
---

# Switchroom Telegram Plugin Reference

The `switchroom-telegram` plugin is an enhanced fork of the official Telegram MCP plugin. It's the default for all switchroom agents.
