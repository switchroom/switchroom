...
export const CASES = [
  ...
  {
    name: '3-space indented `<!--` still opens a block',
    md: doc(['   <!--', '## v0.0.1 — swallowed', '-->']),
    commonmarkH2: ['Unreleased', 'v9.9.9'],
    guardH2: ['## Unreleased', '## v9.9.9'],
    agrees: true,
    why: 'Up to 3 leading spaces are allowed before an HTML block opener.',
  },
  {
  ...
  {
    name: '3-space indented fence opens',
    md: doc(['   ```', '## v0.0.1', '   ```']),
    commonmarkH2: ['Unreleased', 'v9.9.9'],
    guardH2: ['## Unreleased', '## v9.9.9'],
    agrees: true,
    why: 'Up to 3 spaces of indent are allowed on a fence opener.',
  },
  {
