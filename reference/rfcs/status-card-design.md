...
safety net. See [`conversational-pacing.md`](conversational-pacing.md)
for the design contract that replaces it.

This stub is kept so historical links resolve; the v2 spec lived here.
