...
import { registerHostCliUpgradeCommand } from "./host-cli-upgrade.js";
...
import { registerMentalModelRefreshCommand } from "./mental-model-refresh.js";
import { registerHindsightBenchCommand } from "./hindsight-bench.js";
...
registerHostCliUpgradeCommand(program);
...
registerMentalModelRefreshCommand(program);
registerHindsightBenchCommand(program);
