...
JTBD: `reference/jobs/extend-without-forking.md` ("the user adds a new
...
The governing JTBD is `reference/jobs/extend-without-forking.md` ("the user
...
before PR-3 starts coding. Doc PR adding `reference/rfcs/
...
- `reference/rfcs/admin-agent-config-edit.md` — direct shape parallel;
  this RFC reuses the approval-card + hostd-verb pattern
- `reference/rfcs/eliminate-claude-p.md` — hard constraint that no skill
  proposal can introduce a `claude -p` path
- `reference/rfcs/approval-kernel.md` — the approval surface
