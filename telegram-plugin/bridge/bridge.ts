          ...
          items: {
            ...
            items: {
              ...
              properties: {
                ...
                inline_keyboard_confirm: { type: 'boolean', description: 'Per-message override for the "✅ You chose: <label> · HH:MM" body annotation on tap (#789). true forces the annotation even if the agent default is off; false skips it even if the agent default is on; omit to use the agent default. Only applies to single-use keyboards and requires the agent parseMode to be the default html.' },
              },
              required: ['text'],
            },
          },
